...
@Component({
  selector: 'app-tv-airing-tv-shows',
  templateUrl: './tv-airing-tv-shows.component.html',
  styleUrls: ['./tv-airing-tv-shows.component.scss']
})
export class TvAiringTvShowsComponent implements OnInit {
